...
/******/ 	var hotCurrentHash = "4e4eae9bd105ac010001"; // eslint-disable-line no-unused-vars
...
_vue2.default.component('editor-view', {
  data: function data() {
    return {
      input: {
        text: '',
  ...
  methods: {
    ...
    save: function save() {
      // this.input のクローンを生成
      var data = (0, _assign2.default)({}, this.input, { tags: this.tagsArr });
      // 'add'イベントを自身にトリガーする
      this.$emit('add', data);
    }
  }
...
_vue2.default.component('list-view', {
  props: {
    memos: Array
  },
...
var _EditorView = __webpack_require__(10);
